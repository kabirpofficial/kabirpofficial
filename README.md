...
Open to remote backend or full-stack roles. I have accumulated over 5+ years of experience in this field and possess expertise in programming languages including PHP, JavaScript, MySQL, and MongoDB. I have a passion for continuously learning and staying updated with emerging technologies. I am a die-hard Linux fan and open-source enthusiast, always exploring and building within the Linux ecosystem. Available for remote opportunities.
...
![Linux Server](https://img.shields.io/badge/-Linux_Server-FCC624?logo=linux&logoColor=000000)
![DevOps](https://img.shields.io/badge/-DevOps-0A66C2?logo=azure-devops&logoColor=white)
